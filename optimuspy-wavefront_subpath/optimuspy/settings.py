...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            ...
            'exchange': 'groups',  # не было раньше
            'exchange_type': 'direct',  # не было раньше
        },
    },
}

CELERY_DEFAULT_EXCHANGE = 'groups' # не было раньше
CELERY_DEFAULT_EXCHANGE_TYPE = 'direct' # не было раньше
...
CELERY_TASK_ROUTES = {
    'web.tasks.compiler_job_default': {'queue': 'default'},
    'web.tasks.compiler_job_gpu': {'queue': 'gpu'},
    'web.tasks.compiler_job_highmem': {'queue': 'highmem'},
    'web.tasks.run_single_benchmark_default': {'queue': 'default'},
    'web.tasks.run_single_benchmark_gpu': {'queue': 'gpu'},
    'web.tasks.run_single_benchmark_highmem': {'queue': 'highmem'},
}
